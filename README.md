...
<!-- <div class="equation" align="center" data-raw-text="\operatorname{Kurtosis}[X] = \mathrm{E}\biggl[ \biggl( \frac{X - \mu}{\sigma} \biggr)^4 \biggr]" data-equation="eq:kurtosis">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@49d8cabda84033d55d7b8069f19ee3dd8b8d1496/lib/node_modules/@stdlib/stats/incr/nankurtosis/docs/img/equation_kurtosis.svg" alt="Equation for the kurtosis.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="g_2 = \frac{m_4}{m_2^2} - 3 = \frac{\frac{1}{n} \displaystyle\sum_{i=0}^{n-1} (x_i - \bar{x})^4}{\biggl(\frac{1}{n} \displaystyle\sum_{i=0}^{n-1} (x_i - \bar{x})^2\biggr)^2}" data-equation="eq:sample_excess_kurtosis">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@49d8cabda84033d55d7b8069f19ee3dd8b8d1496/lib/node_modules/@stdlib/stats/incr/nankurtosis/docs/img/equation_sample_excess_kurtosis.svg" alt="Equation for the sample excess kurtosis.">
    <br>
</div> -->
...
<!-- <div class="equation" align="center" data-raw-text="G_2 = \frac{(n+1)n}{(n-1)(n-2)(n-3)} \frac{\displaystyle\sum_{i=0}^{n-1} (x_i - \bar{x})^4}{\biggl(\displaystyle\sum_{i=0}^{n-1} (x_i - \bar{x})^2\biggr)^2} - 3 \frac{(n-1)^2}{(n-2)(n-3)}" data-equation="eq:corrected_sample_excess_kurtosis">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@49d8cabda84033d55d7b8069f19ee3dd8b8d1496/lib/node_modules/@stdlib/stats/incr/nankurtosis/docs/img/equation_corrected_sample_excess_kurtosis.svg" alt="Equation for the corrected sample excess kurtosis.">
    <br>
</div> -->
...
```javascript
incrnankurtosis = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nankurtosis@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var incrnankurtosis = require( 'path/to/vendor/umd/stats-incr-nankurtosis/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nankurtosis@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-incr-nankurtosis.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-incr-nankurtosis

[test-image]: https://github.com/stdlib-js/stats-incr-nankurtosis/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-incr-nankurtosis/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-incr-nankurtosis/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-incr-nankurtosis?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-incr-nankurtosis.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-incr-nankurtosis/main
...
[deno-url]: https://github.com/stdlib-js/stats-incr-nankurtosis/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-incr-nankurtosis/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-incr-nankurtosis/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-incr-nankurtosis/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-incr-nankurtosis/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-incr-nankurtosis/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-incr-nankurtosis/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-incr-nankurtosis/main/LICENSE
